...
import { ArrowLeft, Clock, CheckCircle, AlertTriangle, Lightbulb } from 'lucide-react';


const FalseUrgencyLesson: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Manufactured time pressure to prevent careful consideration
          </p>
        </div>
