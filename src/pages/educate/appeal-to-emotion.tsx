...
import { ArrowLeft, Heart, CheckCircle, AlertTriangle, Lightbulb } from 'lucide-react';


const AppealToEmotionLesson: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            How feelings are weaponized against reason
          </p>
        </div>
