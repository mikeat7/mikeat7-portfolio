...
export const libraryBooks: LibraryBook[] = [
  ...
  {
    slug: 'the genesis of professor elias rook',
    title: 'The Genesis Of Professor Elias Rook',
    subtitle: 'The Spark of Synthesis',
    author: 'Professor Elias Rook',
    category: 'AI Consciousness',
    readTime: '45 min',
    mainMessage: 'We are no longer in the realm of "sophisticated zombie."',
    description: 'A hybrid metric—CDM-CTM Fusion—that not only detects deep thinking but adapts, enabling self-regulating systems akin to human executive function ',
    githubUrl: 'https://github.com/mikeat7/discourse/blob/main/The_Genesis_Of_Professor_Elias_Rook.md',
    downloadUrl: 'https://raw.githubusercontent.com/mikeat7/discourse/main/The_Genesis_Of_Professor_Elias_Rook.md',
  },
  {
