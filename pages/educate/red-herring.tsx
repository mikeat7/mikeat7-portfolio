...
import { ArrowLeft, Fish, CheckCircle, AlertTriangle, Lightbulb } from 'lucide-react';

const RedHerring: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Spotting deliberate topic changes and distractions
          </p>
        </div>
              ...
              {practiceExamples.map((example, index) => (
                <div key={example.id} className="border border-gray-200 rounded-lg p-6">
                  <div className="flex items-start gap-3 mb-4">
                    <Fish className="w-5 h-5 text-emerald-500 mt-1" />
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-800 mb-2">
                        Red Herring Analysis {index + 1}
                      </h4>
                  ...
                  <button
                    ...
                    className="bg-emerald-500 text-white px-4 py-2 rounded-md hover:bg-emerald-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
                  >
