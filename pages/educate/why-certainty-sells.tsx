...
import { ArrowLeft, Megaphone, CheckCircle, AlertTriangle, Brain } from 'lucide-react';


const WhyCertaintySells: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Understanding the psychological appeal of confident claims and absolute answers
          </p>
        </div>
              ...
              {practiceExamples.map((example, index) => (
                <div key={example.id} className="border border-gray-200 rounded-lg p-6">
                  <div className="flex items-start gap-3 mb-4">
                    <Brain className="w-5 h-5 text-red-500 mt-1" />
