...
import { ArrowLeft, UserX, CheckCircle, AlertTriangle, Lightbulb } from 'lucide-react';


const AdHominem: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            When the person is attacked instead of their argument
          </p>
        </div>
              ...
              {practiceExamples.map((example, index) => (
                <div key={example.id} className="border border-gray-200 rounded-lg p-6">
                  <div className="flex items-start gap-3 mb-4">
                    <UserX className="w-5 h-5 text-red-500 mt-1" />
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-800 mb-2">
                        Ad Hominem Analysis {index + 1}
                      </h4>
