...
import { ArrowLeft, Shield, CheckCircle, AlertTriangle, Lightbulb } from 'lucide-react';


const Steelman: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            The opposite of straw man - strengthening opposing arguments
          </p>
        </div>
            ...
            <div className="space-y-8">
              ...
              {practiceExamples.map((example, index) => (
                <div key={example.id} className="border border-gray-200 rounded-lg p-6">
                  ...
                  >
                    {showAnswers[example.id] ? 'Answer Revealed' : 'Show Expert Steelman'}
                  </button>
                  ...
                  {showAnswers[example.id] && (
                    <div className="mt-4 p-4 bg-purple-50 border border-purple-200 rounded-md">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <h5 className="font-semibold text-purple-800 mb-2">Expert Steelman:</h5>
